...
dirname = '/media/flywalk/data/imaging/'
...
startSegment = 0
totalLoops = 5    #total number of times the imaging loop runs
fps = 250
extension = '.png'

processScaleFactor = 0.1
displayRate = 15
displayScale = 2
framedelThresh = 3
avgWeight = 0.001
...
def showIm(frameDelta, displayScale, imShowBorders, borderValue):
    cv2.imshow('img', np.pad(cv2.resize(frameDelta, (0,0), fx = displayScale, fy = displayScale)\
